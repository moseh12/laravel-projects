...
<div class="form-group">
    ...
    <div class="radio-group">
        ...
        <label for="daysLimited">Limited</label>
...
<div class="form-group">
    ...
    <div class="radio-group">
        <input type="radio" id="itemsLimited" name="items" value="limited">
        <label for="itemsLimited">Limited</label>
        <input type="radio" id="itemsUnlimited" name="items" value="unlimited">
